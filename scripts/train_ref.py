...
def train_q_agent(num_episodes=10000, eval_every=1000):
    ...
    agent = QAgent(
        ...
        epsilon_start=1.0,
        epsilon_end=0.01,
        epsilon_decay=0.9995,  # Slow decay for longer exploration
        seed=42
    )
    ...
    random_reward, random_win_rate = evaluate_agent(random_agent, env, 1000)
    print(".3f")
    print(".1%")
...
def main():
    ...
    # Train agent
    agent, rewards, win_rates = train_q_agent(num_episodes=5000, eval_every=500)
